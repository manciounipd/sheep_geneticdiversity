...
''' This program converts Illumina row format into PLINK ped and map formats.
    ...
    https://github.com/bioinformatics-ptp/Zanardi.git
    
    Coded originally by: Ezequiel L. Nicolazzi (PTP Science Park, Lodi, Italy)
...
for x in SNPname:
    if x not in conv: bomb("SNP: "+x+" in FinalReport is not present in SNP map!!!")
